  ...
  return (
    <div className="mt-[140px] mb-[24px] w-[85%] mx-auto">
      ...
      <div className="mt-[32px]">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-end gap-[12px]">
            {/* <button
              ...
              className="bg-color-primary w-[120px] text-[14px] h-[30px] text-center flex items-center justify-center  py-1 border-2 border-primary-700 px-[24px] rounded-[10px] text-white"
            >
              اشترك الآن
            </button> */}
            <div className="flex whitespace-nowrap">
              {data?.body?.sale?.id && (
                <div className="flex items-center ml-[12px] mt-[20px] gap-[24px]">
                  <div className="bg-[#454545] text-[14px] font-bold text-white py-[2px] px-[8px] line-through rounded-[8px]">
                    {data?.body?.price} جنيه
                  </div>
                  <div className="bg-[#1EAD7B] text-[14px]  text-center font-bold text-white py-[2px] px-[8px]  rounded-[8px]">
              ...
              {data?.body?.sale?.id && (
                <div className="flex flex-col gap-1 items-center">
                  <div className="flex items-center">
                    <h2 className="text-[#121212] ml-4 text-[14px] font-bold">
                      احصل على خصم
                    </h2>
        ...
        <span className="text-[#454545] text-[18px] font-bold">تحتوى على </span>
        ...
        {/* <div className="mt-[250px]  flex  flex-wrap  items-center justify-center flex-col w-full mx-auto">
          <div className="border font-bold  items-center flex flex-wrap  gap-[24px] rounded-[8px]  py-[32px] px-[40px] border-color-primary">
            ...
            <div className="relative font-bold  text-nowrap">
              ...
              <h3 className="text-color-primary flex items-center relative z-10 text-[28px]">
                {data?.body?.price -
                  ((100 - data?.body?.sale?.discount_value) / 100) *
                    data?.body?.price}
                جنيه
