  ...
  return (
    <div
      ...
      className="bg-[#F9FAFC] md:text-2xl whitespace-nowrap
               font-bold mx-auto -mt-8 flex max-md:justify-center flex-wrap md:gap-x-6 gap-x-4 gap-y-1 items-center  max-w-[min(85%,760px)] w-full relative border py-3 md:py-8 px-6 md:px-10 border-[#012D5A] rounded-[8px]"
    >
      ...
      <div className="relative   ">
        ...
        <h3 className="text-color-primary flex items-center relative   z-10 text-[32px]">
          <span>%</span>
          <span>{progress}</span>
        </h3>
      </div>
