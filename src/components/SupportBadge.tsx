...
function SupportBadge({ gradeId }: { gradeId: number }) {
  return (
    <a
      ...
      className="bg-primary-700 text-white p-3 rounded-md w-[155px] h-10 flex items-center gap-3 justify-center outline-solid font-bold outline-1 outline-offset-2"
      target="_blank"
    >
