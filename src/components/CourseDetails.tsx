          ...
          <div className="flex font-bold justify-center w-full gap-2 md:gap-6 my-10 ">
            {Tabs3.map((tab, index) => (
              <TabsTrigger
                key={index}
                value={tab.value}
                className={`min-w-24 rounded-[8px] data-[state=active]:bg-[#012D5A] data-[state=active]:text-white bg-white text-[#523412] flex items-center border border-primary-700 px-px py-1 md:p-2 `}
              >
