      ...
      <div className="flex flex-col gap-4 ">
        ...
        {data?.announcements.map((announce, idx) => (
          <div
            ...
            className="p-4 bg-[url('/assets/announcementBg.svg')] bg-no-repeat bg-position-[center_left] flex flex-wrap items-center min-h-[121px] justify-between px-10 gap-5 bg-background border  text-[14px] font-bold text-[#523412] border-primary-700 rounded-[8px]   relative"
          >
            ...
            {announce.file && (
              <a
                ...
                className="p-3 h-8 flex max-w-[170px] text-nowrap items-center gap-3 rounded-[8px] h-[3 text-white border border-[#9D8242] bg-color-primary text-xs md:text-[14px] font-bold"
              >
                <Download />
                نزل الملف من هنا
              </a>
