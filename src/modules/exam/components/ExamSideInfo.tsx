...
function ExamSideInfo({ start, data, setShowRoom, defaultTitle = "امتحان" }) {
  return (
    <div className="md:min-w-[280px] flex flex-col items-center justify-center border rounded-[8px] p-4 border-[#012D5A]  max-h-[329px] bg-[#F9FAFC]">
      ...
      {data && !!data?.questions?.length && (
        <div className="flex mt-[16px] items-center gap-2">
          ...
          <h2 className="text-[18px] font-medium text-[#454545]">
            عدد الأسئلة
          </h2>
      ...
      <button
        ...
        className="bg-color-primary text-[14px] mt-[16px] text-white font-bold w-[159px] gap-2 rounded-[10px] flex justify-center items-center py-2 border border-primary-700"
      >
