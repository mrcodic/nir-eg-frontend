...
export type ItemBadgeVariants = keyof typeof variants;
export type ItemBadgeSides = keyof typeof sides;

const StoreItemCardBadge = ({
  variant = "out-of-stock",
  side = "tl",
  className,
  text,
}: {
  variant?: ItemBadgeVariants;
  side?: ItemBadgeSides;
  className?: string;
  text: string;
}) => {
...
export default StoreItemCardBadge;
