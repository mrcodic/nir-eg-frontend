    ...
    <div className=" relative md:text-2xl font-bold  flex flex-col  lg:col-span-5 col-span-12  border p-6 border-[#012D5A] rounded-lg ">
      ...
      {paymentTypes.length > 0 && (
        <button
          ...
          className="bg-color-primary cursor-pointer mt-10 text-center border border-primary-700 flex items-center justify-center h-10 rounded-[8px] w-full text-[14px] font-bold p-2 text-white"
        >
          دفع
        </button>
      )}
