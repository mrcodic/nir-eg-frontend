...
const PaymentCom = ({
  ...
  return (
    <div
      ...
      className="border-primary-800 relative z-10 mx-auto -mt-8 flex w-full max-w-[min(760px,85%)] flex-col justify-center rounded-lg border bg-white px-4 py-3 font-bold md:w-[760px] md:py-4 md:text-[24px]"
    >
      <PaymentUI
